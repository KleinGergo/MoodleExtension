        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TakenCourseID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Semesters", x => x.ID);
                    table.ForeignKey(
                        name: "FK_Semesters_TakenCourses_TakenCourseID",
                        column: x => x.TakenCourseID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StudentsNeptuncode = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TakenCoursesTakenCourseID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentTakenCourse", x => new { x.StudentsNeptuncode, x.TakenCoursesTakenCourseID });
                    table.ForeignKey(
                        name: "FK_StudentTakenCourse_Students_StudentsNeptuncode",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Semesters_TakenCourseID",
                table: "Semesters",
                column: "TakenCourseID");
